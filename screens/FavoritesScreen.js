...
function FavoritesScreen({ theme }) {
        ...
        <Surface style={styles.surface}>
          ...
          <View style={styles.infoContainer}>
            <View style={styles.sectionContainer}>
              ...
              <Title style={{ color: colors.primary }}>${currentPrice}</Title>
            </View>
            <View style={styles.sectionContainer}>
              <Caption>Last 24h: </Caption>
              <Caption
                style={{
                  color: priceChange24h < 0 ? colors.error : colors.accent
                }}
              >
                {priceChange24h}
              </Caption>
  ...
  const renderFooter = () =>
    isLoading && <Button style={styles.footer} loading={isLoading} />;
